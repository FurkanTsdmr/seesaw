...
Demo <br/>
Live Demo <br/>
[Website Link](https://seesawfurkan.netlify.app/) <br/>
<hr/>
<img width="1507" height="860" alt="image" src="https://github.com/user-attachments/assets/25f448e2-ff1f-4dab-99cb-78ba8da5adbd" /> <br/><hr/>
<img width="604" height="862" alt="image" src="https://github.com/user-attachments/assets/0b3900a4-7674-4289-9c0a-10305fde1098" /> <br/>
...
The project is split into focused modules: <br/>

app.js — core logic, events, simulation <br/>
...
sound.js — mute toggle and drop sound <br/>
...
Sound requires user interaction before playing due to browser autoplay policy — this is handled gracefully with a try/catch. <br/>
